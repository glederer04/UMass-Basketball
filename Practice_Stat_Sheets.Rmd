...
save_name1 <- paste0(format(Sys.Date(), format="%m-%d-%Y"), " | Complete Totals Stat Sheet.png")
save_name2 <- paste0(format(Sys.Date(), format="%m-%d-%Y"), " | Basic Totals Stat Sheet.png")
```
