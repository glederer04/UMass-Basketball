...
library(dplyr)
library(gtExtras)
knitr::opts_knit$set(root.dir = '/Users/gregorylederer/Desktop/Umass Basketball/Visuals')
```
...
```{r}
week <- '4'
table_subtitle <- paste0('Week ', week, " | Complete Totals")
table_subtitle_a <- paste0('Week ', week, " | Advanced Totals")
save_name1 <- paste0('Week ', week, " - Complete Totals Stat Sheet.png")
save_name2 <- paste0('Week ', week, " - Basic Totals Stat Sheet.png")
save_name3 <- paste0('Week ', week, " - Advanced Totals Stat Sheet.png")
```
